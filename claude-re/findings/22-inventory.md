...
# Superseded Finding: `22-inventory.md`

- original category: raw inventory full/partial/group handler dumps
- contained raw decompilation/function dump: yes
- canonical replacement: `re-resources/docs/kb/services/inventory-service.md; glossary/packets-s2c.md; Ghidra DB`
- old content fingerprint before replacement: `cbe57da9b548edc8`
