...
# Superseded Finding: `38-world-entry-timeline.md`

- original category: world-entry packet order by cycle
- contained raw decompilation/function dump: no
- canonical replacement: `re-resources/docs/kb/flow/03-world-login.md; flow/04-scene-rebuild.md`
- old content fingerprint before replacement: `4dc43b8e5d69e0f5`
