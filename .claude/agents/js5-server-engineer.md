...
**⚠️ The 216 binary is an OSRS debug build — engine-reference only.** The shared NXT JS5/cache *engine* (~935, embedded in 216) can help name 948's stripped JS5 functions, but **OSRS and RS3 are separate games**: do NOT assume 216's JS5 *protocol* (request/response framing, opcodes, archive/index numbering) matches RS3 948 — verify every wire detail against the 948-5 binary + 948-5 captures. 948-5 is the only truth. See `docs/binary/216-osrs-nxt-reference.md`.
