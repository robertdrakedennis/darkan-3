...
internal fun Codec.registerRev948ServerProtStubs() {
    ...
    s(7, "UNKNOWN_7", 0)                             // GHIDRA_9485 — descriptor 0x100f0f3b0; handler jag::packethandlers::Misc::RESET_ENTITY_LISTS_OP7 @0x100084290 walks player/NPC manager lists and invokes entity vfunc +0x1a0 for active entries. Name stays UNKNOWN_7 because no official beta enum symbol maps.
    ...
    s(169, "UNKNOWN_169", 8)                         // UNKNOWN (2026-06-25 audit; 2026-06-27 rechecked) — was mislabeled SEND_PING in pass 1; op169 reads a g8 server timestamp (latency delta), not the anti-cheat challenge. No confident official name. No encoder. sz8.
