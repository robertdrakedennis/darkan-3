...
├── .Codex/agents/   .Codex/commands/      # merged agent roster + re-* RE commands
...
RE **commands** (`.Codex/commands/`): `/re-analyze`, `/re-identify`, `/re-overview`,
...
4. Read the new offset off the analogous instruction; rename + comment; feed the name back to the
   ...
   in `.Codex/agents/ghidra-reverse-engineer.md`. Operational guide:
