...
class BZIP2Decompressor {
    ...
    fun decompress(decompressed: ByteArray, uncompressedSize: Int, archiveData: ByteArray, startOffset: Int = 0): Int {
        synchronized(bzip2BlockEntry) {
            ...
            bzip2BlockEntry.uncompressedSize = uncompressedSize
            ...
            return uncompressedSize - bzip2BlockEntry.uncompressedSize
        }
    }
    ...
    fun method151(arg0: BZIP2BlockEntry) {
        ...
        var i_87_ = arg0.uncompressedSize
        val i_88_ = i_87_
