...
import com.undercut.cache.charToCp1252

enum class CS2VarType(val id: Int, val display: String, val c: Char, val type: BaseVarType, val defaultVal: Any) {
    INT(0, "INT", 'i', BaseVarType.INTEGER, 0),
    BOOLEAN(1, "BOOLEAN", '1', BaseVarType.INTEGER, 0),
    TYPE_2(2, "TYPE_2", '2', BaseVarType.INTEGER, -1), // TODO
    ...
    TYPE_13(13, "TYPE_13", 'O', BaseVarType.INTEGER, -1), // TODO
    SYNTH(14, "SYNTH", 'P', BaseVarType.INTEGER, -1),
    TYPE_15(15, "TYPE_15", 'Q', BaseVarType.INTEGER, -1), // TODO
    ...
    WORLDTILE(22, "WORLDTILE", 'c', BaseVarType.INTEGER, -1),
    ...
    OBJECT(30, "OBJECT", 'l', BaseVarType.INTEGER, -1),
    MODEL(31, "MODEL", 'm', BaseVarType.INTEGER, -1),
    NPC(32, "NPC", 'n', BaseVarType.INTEGER, -1),
    ITEM(33, "ITEM", 'o', BaseVarType.INTEGER, -1),
    ...
    TYPE_54(54, "TYPE_54", '\u00a2', BaseVarType.INTEGER, -1), //TODO
    ...
    TYPE_75(75, "TYPE_75", '\u00a4', BaseVarType.INTEGER, -1), // TODO
    ...
    TYPE_90(90, "TYPE_90", '\u00dc', BaseVarType.INTEGER, -1), // TODO
    ...
    companion object {
        private val legacyMappings = Array<CS2VarType?>(256) { null }
        private val BY_ID = mutableMapOf<Int, CS2VarType>()
        private val BY_CHAR = mutableMapOf<Char, CS2VarType>()

        init {
            CS2VarType.entries.forEach { t ->
                legacyMappings[t.c.charToCp1252().toInt() and 0xff] = t
                BY_ID[t.id] = t
                BY_CHAR[t.c] = t
            }
        }

        fun getById(id: Int): CS2VarType {
            return BY_ID[id] ?: throw Exception("Invalid CS2VarType $id")
        }

        fun getByChar(c: Char): CS2VarType {
            return BY_CHAR[c] ?: throw Exception("Invalid CS2VarType $c")
        }
    }
}